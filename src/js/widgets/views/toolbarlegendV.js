            ...
            itemsTemplate = '<script id="itemsTmpl" type="text/html">';
                itemsTemplate += ' <ul class="gcviz-legendULLayer" id="layerList"  data-bind="foreach: $data">';
                    itemsTemplate += '<li  class="gcviz-legendLiLayer" data-bind="LegendItemList: { expanded: expand }, click: $root.toggleViewService">';
                            itemsTemplate += '<div class="gcviz-legendHolderDiv" data-bind="if: visibility.enable"><input class="gcviz-legendCheck" type="checkbox" data-bind="click: $root.changeItemsVisibility, attr: { title: $root.tpVisible, checked: visibility.initstate }"/></div>';
                            ...
                            itemsTemplate += '<div class="gcviz-legendHolderDiv" data-bind="if: metadata.enable"><span><a class="gcviz-legendLink" target="_blank" data-bind="attr: { href: metadata.value, title: metadata.alttext, alt: metadata.alttext }, text: label.value"></a></span></div>';
                            itemsTemplate += '<div class="gcviz-legendHolderDiv" data-bind="ifnot: metadata.enable"><span data-bind="text: label.value"></span></div>';
                            ...
                            itemsTemplate += '<div class="gcviz-legendSymbolDiv" data-bind="attr: { id: \'featureLayerSymbol\' + id }"></div>';
                        itemsTemplate += '</li>';
                    itemsTemplate += '</ul>';
