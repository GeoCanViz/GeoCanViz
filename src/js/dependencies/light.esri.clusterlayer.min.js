//https://github.com/odoe/esri-clusterfeaturelayer/blob/master/ClusterFeatureLayer.js
define([
  "dojo/_base/declare",
  "dojo/_base/array",
  "dojo/_base/Color",
...
'esri/renderers/ClassBreaksRenderer',
  ...
  return declare([GraphicsLayer], {
	...
	_setMap: function(map, surface) {
		...
		// set renderer
		this._setRenderer(this._defaultRenderer);
      ...
      // replace by onExtentChange and get only feature in zoom extent (j. levesque)
	...
	_getFeatExtent: function(map) {
		this._featExtent = [];
        var feat, geom,
        	features = map.getLayer('clusters')._clusterData;
        	len = map.getLayer('clusters')._clusterData.length;
        while (len--) {
        	feat = features[len];
        	geom = new Point(feat.x, feat.y, '3978');
	...
	_setRenderer: function(renderer) {
		...
		if (renderer === null) {
			...
			var defaultSym = new sms('circle').setSize(5);
    ...
    _clusterCreate: function(p) {
      ...
      p.attributes.clusterCount = 1;
      p.attributes.extent = [ p.x, p.y, p.x, p.y ];
      ...
      cluster.attributes = p.attributes;
